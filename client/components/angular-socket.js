var module = angular.module('socket.io', ['config']);

module.provider('$socket', function $socketProvider(config) {
    var ioUrl = config.urlSocket;
    var ioConfig = {};
    ...
    this.$get = function $socketFactory($rootScope) {
        ...
        return {
            ...
            disconnect: function disconnect(close) {
